...
public class OsafeAdminCatalogServices {
    ...
    public static Map<String, Object> createProductFeatureAppl(DispatchContext dctx, Map<String, ? extends Object> context)
    {
        ...
        try 
        {
        	GenericValue productFeatureAppl = EntityQuery.use(delegator).from("ProductFeatureAppl").where("productId", productId, "productFeatureId", productFeatureId, "fromDate", fromDate).queryOne();
