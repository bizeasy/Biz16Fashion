...
public class OsafeAdminPricingServices {
    ...
    public static Map<String, Object> createUpdateProdPriceRule(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        try {
            for(String productIds : productIdList) {
                List<GenericValue> productPriceCondList = delegator.findByAnd("ProductPriceCond", UtilMisc.toMap("inputParamEnumId", "PRIP_PRODUCT_ID", "condValue", productIds), null, false);
                if(UtilValidate.isNotEmpty(productPriceCondList)) {
                    ...
                    for(String productPriceRuleId : productPriceRuleIdList) {
                        ...
                        List<GenericValue> prdQtyBreakIdCondList = delegator.findByAnd("ProductPriceCond", UtilMisc.toMap("inputParamEnumId","PRIP_QUANTITY", "productPriceRuleId",productPriceRuleId), null, false);
                        if (UtilValidate.isNotEmpty(prdQtyBreakIdCondList)) {
                          //Check for Active Price Rule
                            List<GenericValue> productPriceRuleList = delegator.findByAnd("ProductPriceRule", UtilMisc.toMap("productPriceRuleId",productPriceRuleId), null, false);
    ...
    public static Map<String, Object> deleteProdPriceRule(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        try {
            ...
            List<GenericValue> productPriceCondList = delegator.findByAnd("ProductPriceCond", UtilMisc.toMap("productPriceRuleId", productPriceRuleId), null, false);
          ...
          //Delete Record From ProductPriceAction
            List<GenericValue> productPriceActionList = delegator.findByAnd("ProductPriceAction", UtilMisc.toMap("productPriceRuleId", productPriceRuleId), null, false);
          ...
          //Delete Record From ProductPriceRule
            GenericValue prodPriceRule = EntityQuery.use(delegator).from("ProductPriceRule").where("productPriceRuleId", productPriceRuleId).queryOne();
