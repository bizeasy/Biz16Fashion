...
public class FeedsUtil {
	...
	public static String getPartyPhoneNumber(String partyId, String contactMechPurposeTypeId, Delegator delegator) {
		...
		try {
			...
			List<GenericValue> partyPhoneDetails = delegator.findByAnd("PartyContactDetailByPurpose", UtilMisc.toMap("contactMechPurposeTypeId", contactMechPurposeTypeId, "partyId", partyId), null, false);
	...
	public static String getPartyPhoneExt(String partyId, String contactMechPurposeTypeId, Delegator delegator) {
		...
		try {
			...
			List<GenericValue> partyPhoneExtDetails = delegator.findByAnd("PartyContactDetailByPurpose", UtilMisc.toMap("contactMechPurposeTypeId", contactMechPurposeTypeId, "partyId", partyId), null, false);
