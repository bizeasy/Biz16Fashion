...
<div class="displayBox topProducts">
    ...
    <div class="boxBody">
        ...
        <#if storePickupTopProductsList?has_content>
          <#assign storePickupTopProductsList = Static["org.apache.ofbiz.entity.util.EntityUtil"].orderBy(storePickupTopProductsList,Static["org.apache.ofbiz.base.util.UtilMisc"].toList("unitPrice DESC")) />
            <#assign rowClass = "1">
