<#if postalAddress?has_content>
                ...
                <#if postalAddress.stateProvinceGeoId?has_content && postalAddress.stateProvinceGeoId != '_NA_'>
                    <span>
                        <#if STATE?has_content && STATE == 'LONG'>
                            <#assign stateProvince = delegator.findOne("Geo", {"geoId" : postalAddress.stateProvinceGeoId}, true)?if_exists>
 ...
 <#elseif displayFormat == "MULTI_LINE_STREET_CITY_STATE">
    <ul class="displayList address">
        <#if postalAddress.toName?has_content>
            <li>
                <div>
 ...
 <#elseif displayFormat == "SINGLE_LINE_STREET_CITY_STATE">
    <ul class="displayList address">
      <li>
       <div>
        <#if postalAddress.toName?has_content>
 ...
 <#elseif displayFormat == "SINGLE_LINE_CITY">
    <ul class="displayList address">
      <li>
       <div>
            <#if postalAddress.city?has_content && postalAddress.city != '_NA_'>
 ...
 <#elseif displayFormat == "SINGLE_LINE_STATE">
    <ul class="displayList address">
      <li>
       <div>
            <#if postalAddress.stateProvinceGeoId?has_content && postalAddress.stateProvinceGeoId != '_NA_'>
 ...
 <#elseif displayFormat == "SINGLE_LINE_ZIP">
    <ul class="displayList address">
      <li>
       <div>
            <#if postalAddress.postalCode?has_content && postalAddress.postalCode != '_NA_'>
