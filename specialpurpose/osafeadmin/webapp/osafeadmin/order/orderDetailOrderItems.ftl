                              ...
                              <#if productPromoCode?has_content>
                                <#list productPromoCode as promoCode>
                                  ...
                                  <#if promoCodeEnteredId?has_content>
                                      ...
                                      <#assign toolTipData = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", "OfferPriceHelperInfo", Static["org.apache.ofbiz.base.util.UtilMisc"].toList(promoCodeText!""), locale)/>
                                      </#if>
                                  </#if>
                                </#list>
                              </#if>
