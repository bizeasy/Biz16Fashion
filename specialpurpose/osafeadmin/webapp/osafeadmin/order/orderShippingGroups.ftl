                            ...
                            <#if content?has_content>
                                ...
                                <#if dataResource?has_content>
                                    ...
                                    <#if trackingURL?has_content>
                                        <#assign trackingURL = Static["org.apache.ofbiz.base.util.string.FlexibleStringExpander"].expandString(trackingURL, {"TRACKING_NUMBER":orderItemShipGroup.trackingNumber})/>
                                    </#if>
                                </#if>
                            </#if>
                        </#if>
