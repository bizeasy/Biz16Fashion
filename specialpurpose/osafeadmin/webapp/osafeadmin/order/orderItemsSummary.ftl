      ...
      <table class="osafe orderSummary">
        ...
        <#if appliedPromoList?exists && appliedPromoList?has_content>
          <#list appliedPromoList as appliedPromo >
            <tr>
              <#assign orderAdjTotal = Static["org.apache.ofbiz.order.order.OrderReadHelper"].calcOrderAdjustment(appliedPromo.cartAdjustment, shoppingCartSubTotal)!0/>
        ...
        <#if appliedLoyaltyPointsList?exists && appliedLoyaltyPointsList?has_content>
          <#list appliedLoyaltyPointsList as appliedLoyaltyPoints >
            <tr>
              <#assign orderAdjTotal = Static["org.apache.ofbiz.order.order.OrderReadHelper"].calcOrderAdjustment(appliedLoyaltyPoints.cartAdjustment, shoppingCartSubTotal)!0/>
