...
<#escape x as x?xml>
    ...
    <#if placingParty?has_content>
         ...
         <#assign displayPartyNameResult = dispatcher.runSync("getPartyNameForDate", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("partyId", placingParty.partyId, "compareDate", orderHeader.orderDate, "userLogin", userLogin))/>
         <#assign partyContactMechPurpose = placingParty.getRelated("PartyContactMechPurpose")/>
         <#assign partyContactMechPurpose = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByDate(partyContactMechPurpose,true)/>

        <#assign partyPurposeEmails = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByAnd(partyContactMechPurpose, Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("contactMechPurposeTypeId", "PRIMARY_EMAIL"))/>
        <#assign partyPurposeEmails = Static["org.apache.ofbiz.entity.util.EntityUtil"].getRelated("PartyContactMech", partyPurposeEmails)/>
        <#assign partyPurposeEmails = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByDate(partyPurposeEmails,true)/>
        <#assign partyPurposeEmails = Static["org.apache.ofbiz.entity.util.EntityUtil"].orderBy(partyPurposeEmails, Static["org.apache.ofbiz.base.util.UtilMisc"].toList("fromDate DESC"))/>
        <#if partyPurposeEmails?has_content> 
        	<#assign partyPurposeEmail = Static["org.apache.ofbiz.entity.util.EntityUtil"].getFirst(partyPurposeEmails)/>
        ...
        <#assign partyPurposeHomePhones = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByAnd(partyContactMechPurpose, Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("contactMechPurposeTypeId", "PHONE_HOME"))/>
        <#assign partyPurposeHomePhones = Static["org.apache.ofbiz.entity.util.EntityUtil"].getRelated("PartyContactMech", partyPurposeHomePhones)/>
        <#assign partyPurposeHomePhones = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByDate(partyPurposeHomePhones,true)/>
        <#assign partyPurposeHomePhones = Static["org.apache.ofbiz.entity.util.EntityUtil"].orderBy(partyPurposeHomePhones, Static["org.apache.ofbiz.base.util.UtilMisc"].toList("fromDate DESC"))/>
        ...
        <#assign partyPurposeWorkPhones = Static["org.apache.ofbiz.entity.util.EntityUtil"].getRelated("PartyContactMech", partyPurposeWorkPhones)/>
        <#assign partyPurposeWorkPhones = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByDate(partyPurposeWorkPhones,true)/>
        <#assign partyPurposeWorkPhones = Static["org.apache.ofbiz.entity.util.EntityUtil"].orderBy(partyPurposeWorkPhones, Static["org.apache.ofbiz.base.util.UtilMisc"].toList("fromDate DESC"))/>
        ...
        <#assign partyPurposeMobilePhones = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByAnd(partyContactMechPurpose, Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("contactMechPurposeTypeId", "PHONE_MOBILE"))/>
        <#assign partyPurposeMobilePhones = Static["org.apache.ofbiz.entity.util.EntityUtil"].getRelated("PartyContactMech", partyPurposeMobilePhones)/>
        <#assign partyPurposeMobilePhones = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByDate(partyPurposeMobilePhones,true)/>
        <#assign partyPurposeMobilePhones = Static["org.apache.ofbiz.entity.util.EntityUtil"].orderBy(partyPurposeMobilePhones, Static["org.apache.ofbiz.base.util.UtilMisc"].toList("fromDate DESC"))/>
                    ...
                    <fo:table-row>
                        ...
                        <fo:block font-size="8pt">
                                <fo:table table-layout="fixed"  border-start-style="solid" border-start-width="2px" >
                    				...
                    				<fo:table-row >
                    					<fo:table-cell text-align="start">
                    						<fo:block margin-top="2mm" text-indent="2mm" font-weight="bold">${uiLabelMap.InvoiceDateCaption} <#if invoice?has_content>${Static["org.apache.ofbiz.base.util.UtilDateTime"].toDateString(invoice.invoiceDate,preferredDateFormat)!""}</#if></fo:block>
                    					</fo:table-cell>
                    				</fo:table-row >
                    				<fo:table-row >
                    				<fo:table-cell text-align="start">
                        ...
                        <fo:table-cell> 
                	         ...
                	         <fo:table-column column-number="3" column-width="15mm"/>
                               ...
                               <fo:table-row>
                                ...
                                <fo:table-cell >
                                   <fo:block font-size="10pt" text-indent="1mm">${Static["org.apache.ofbiz.base.util.UtilDateTime"].toDateString(orderHeader.entryDate,preferredDateFormat)!""}</fo:block>
                                </fo:table-cell >
                               </fo:table-row>
                               <fo:table-row>
                                <fo:table-cell >
		                    ...
		                    <fo:table-row>
		                      ...
		                      <fo:table-cell border-bottom-style="solid" border-top-style="solid" border-end-style="solid" border-start-style="solid">
		                        <fo:block >
			                        ...
			                        <#assign virtualProductId = Static["org.apache.ofbiz.product.product.ProductWorker"].getVariantVirtualId(line.product)!/>
