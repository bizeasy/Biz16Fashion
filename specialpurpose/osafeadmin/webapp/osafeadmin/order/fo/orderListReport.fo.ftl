   ...
   <#list ordersList as orderHeader>
    ...
    <#assign phones = delegator.findByAnd("PartyContactMechPurpose", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("partyId",payToPartyId,"contactMechPurposeTypeId","PRIMARY_PHONE"))/>
     ...
     <#if placingParty?has_content>
         ...
         <#assign displayPartyNameResult = dispatcher.runSync("getPartyNameForDate", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("partyId", placingParty.partyId, "lastNameFirst","Y", "compareDate", orderHeader.orderDate, "userLogin", userLogin))/>
            ...
            <fo:table-row>
              ...
              <fo:table-cell>
                ...
                <fo:table-body>
                  ...
                  <#assign orderContactMechs = Static["org.apache.ofbiz.party.contact.ContactMechWorker"].getOrderContactMechValueMaps(delegator, orderHeader.get("orderId"))>
				        ...
				        <#list appliedTaxList as appliedTax >
                          ...
                          <fo:table-row>
			                <fo:table-cell number-columns-spanned="2">
						      ...
						      <#assign salesTaxCaption = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels","SummarySalesTaxMultiCaption",taxInfoStringMap, locale ) />
