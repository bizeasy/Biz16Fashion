    ...
    <table class="osafe">
        ...
        <#list shoppingCart.items() as cartLine>
          ...
          <#if !productCategoryId?has_content>
             ...
             <#assign productCategoryMemberList = Static["org.apache.ofbiz.entity.util.EntityUtil"].orderBy(productCategoryMemberList,Static["org.apache.ofbiz.base.util.UtilMisc"].toList('sequenceNum'))/>
             <#if productCategoryMemberList?has_content>
    	          <#assign productCategoryMember = Static["org.apache.ofbiz.entity.util.EntityUtil"].getFirst(productCategoryMemberList)/>
                  <#assign productCategoryId = productCategoryMember.productCategoryId!"">
              </#if>
          </#if>
          <#if product.isVariant?if_exists?upper_case == "Y">
             <#assign virtualProduct = Static["org.apache.ofbiz.product.product.ProductWorker"].getParentProduct(cartLine.getProductId(), delegator)?if_exists>
          ...
          <#if virtualProduct?has_content>
            <#assign virtualProductContentWrapper = Static["org.apache.ofbiz.product.product.ProductContentWrapper"].makeProductContentWrapper(virtualProduct, request)!""/>
          </#if>
         ...
         <tr class="dataRow <#if rowClass?if_exists == "2">even<#else>odd</#if>">
          ...
          <td class="actionColSmall <#if !hasNext?if_exists>lastRow</#if>">
            <#if !cartLine.getIsPromo()>
            	<#assign productIdStringMap = Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("PRODUCT_NO", product.productId!)>
            	<#assign removeCartItemToolTipText = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels","RemoveShoppingCartItemConfirmText",productIdStringMap, locale ) />
                  ...
                  <#list shoppingCart.getAdjustments() as cartAdjustment>
                    ...
                    <#if productPromo?has_content>
                      ...
                      <tr>
	                    ...
	                    <td class="totalValue"><@ofbizCurrency amount=Static["org.apache.ofbiz.order.order.OrderReadHelper"].calcOrderAdjustment(cartAdjustment, shoppingCart.getSubTotal()) rounding=globalContext.currencyRounding isoCode=currencyUom/></td>
	                  </tr>
                    </#if>
                  </#list>
                </#if>
                  ...
                  <#list shoppingCart.getAdjustments() as cartAdjustment>
                    ...
                    <#if loyaltyCartAdjustmentTypeId == "LOYALTY_POINTS">
                      <#if adjustmentType.description?has_content>
                        <tr>
                          <#assign cartAdjTotal = Static["org.apache.ofbiz.order.order.OrderReadHelper"].calcOrderAdjustment(cartAdjustment, shoppingCart.getSubTotal())!0/>
