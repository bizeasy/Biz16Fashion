<table class="osafe">
  ...
  <#if (shoppingCart.size() > 0)>
    ...
    <#list shoppingCart.getProductPromoUseInfoIter() as productPromoUsed>
      ...
      <#assign productPromoUseMap = Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("productPromoCodeId", productPromoUsed.productPromoCodeId, "productPromoId", productPromoUsed.productPromoId, "totalDiscountAmount", productPromoUsed.totalDiscountAmount, "quantityLeftInActions", productPromoUsed.quantityLeftInActions)/>
      <#assign changed = true/>
    ...
    <#list productPromoCodesEntered.iterator() as productPromoCodeEntered>
      <#assign productPromoCode = delegator.findOne("ProductPromoCode", {"productPromoCodeId" : productPromoCodeEntered}, false)/>
        ...
        <tr>
          <td class="idCol firstCol">
            ...
            <#elseif productPromoUseInfo.productPromoId?has_content>
              <#assign productPromo = delegator.findOne("ProductPromo", {"productPromoId" : productPromoUseInfo.productPromoId}, false)/>
          ...
          <td class="statusCol">
            ...
            <#assign is_Float = Static["org.apache.ofbiz.osafe.util.OsafeAdminUtil"].isFloat(qtyLeftInActions!"") />
