  ...
  <#if (shoppingCart.size() > 0)>
      ...
      <#list orderAdjustmentList as orderAdjustmentInfoMap>
        ...
        <tr>
          ...
          <#assign adjustmentInfoMap = Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("includeInTax", orderAdjustment_includeInTax)>
          <#assign adjustmentInfoMap = Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("includeInShipping", orderAdjustment_includeInShipping)>
          <#assign adjustmentInfo = "<p>"+Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels","AdjustmentIncludeInTaxInfo",adjustmentInfoMap, locale )+"</p>">
    	  <#assign adjustmentInfo = adjustmentInfo + "<p>"+Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels","AdjustmentIncludeInShippingInfo",adjustmentInfoMap, locale )+"</p>">
          <td class="actionCol">
