  <#assign paramMap = Static["org.apache.ofbiz.base.util.UtilHttp"].getParameterMap(request, Static["org.apache.ofbiz.base.util.UtilMisc"].toSet("productStoreId","browseRootProductCategoryId","preferredDateFormat", "preferredDateTimeFormat", "entryDateTimeFormat"), false)!""/>
