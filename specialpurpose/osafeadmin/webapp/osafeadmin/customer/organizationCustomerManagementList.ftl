            ...
            <#list resultList as partyRow>
                  ...
                  <tr class="dataRow <#if rowClass == "2">even<#else>odd</#if>">
                   ...
                   <#assign party = delegator.findOne("Party", {"partyId", partyRow.partyId}, false)/>
                    ...
                    <#assign primaryEmail="">
                    <#assign partyContactMechValueMaps = Static["org.apache.ofbiz.party.contact.ContactMechWorker"].getPartyContactMechValueMaps(delegator, partyRow.partyId, false)!""/>
                    ...
                    <#assign contactMechs = Static["org.apache.ofbiz.party.contact.ContactHelper"].getContactMech(party, "BILLING_LOCATION", "POSTAL_ADDRESS", false)!""/>                    
            ...
            <#if (minRow?exists && minRow &gt; 0) >
                <#list 1..minRow as x>
                    ...
                    <tr class="dataRow <#if rowClass?if_exists == "2">even<#else>odd</#if>">
				        ...
				        <#assign primaryEmail="">
				        <#assign partyContactMechValueMaps = Static["org.apache.ofbiz.party.contact.ContactMechWorker"].getPartyContactMechValueMaps(delegator, organizationEmployeeId, false)!""/>
				        <#if partyContactMechValueMaps?has_content>
				            <#list partyContactMechValueMaps as partyContactMechValueMap>
				                <#assign contactMechPurposes = partyContactMechValueMap.partyContactMechPurposes>
				                <#list contactMechPurposes as contactMechPurpose>
