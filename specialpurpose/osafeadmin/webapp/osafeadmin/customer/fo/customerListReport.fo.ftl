...
>
  ...
  <#if customerList?has_content>
   <#list customerList as partyrow>
    ...
    <#assign partyRoles = delegator.findByAnd("ProductStoreRole", {"partyId", partyId}, null, false)>
    ...
    <#assign partyContactMechValueMaps = Static["org.apache.ofbiz.party.contact.ContactMechWorker"].getPartyContactMechValueMaps(delegator, partyId, false)/>
   ...
   <#if partyContactMechPurpose?has_content> 
	   ...
	   <#assign partyShippingLocations = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByOr(partyContactMechPurpose, [Static["org.apache.ofbiz.entity.condition.EntityCondition"].makeCondition("contactMechPurposeTypeId", Static["org.apache.ofbiz.entity.condition.EntityOperator"].EQUALS, "BILLING_LOCATION"),Static["org.apache.ofbiz.entity.condition.EntityCondition"].makeCondition("contactMechPurposeTypeId", Static["org.apache.ofbiz.entity.condition.EntityOperator"].EQUALS, "SHIPPING_LOCATION"),Static["org.apache.ofbiz.entity.condition.EntityCondition"].makeCondition("contactMechPurposeTypeId", Static["org.apache.ofbiz.entity.condition.EntityOperator"].EQUALS, "GENERAL_LOCATION")])/>
	   <#assign partyShippingLocations = Static["org.apache.ofbiz.entity.util.EntityUtil"].getRelated("PartyContactMech", partyShippingLocations)/>
	   <#assign partyShippingLocations = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByDate(partyShippingLocations,true)/>
	   <#assign partyShippingLocations = Static["org.apache.ofbiz.entity.util.EntityUtil"].orderBy(partyShippingLocations, Static["org.apache.ofbiz.base.util.UtilMisc"].toList("fromDate DESC"))/>
	   <#if partyShippingLocations?has_content> 
	        <#assign contactMechList = Static["org.apache.ofbiz.entity.util.EntityUtil"].getRelated("ContactMech",partyShippingLocations)/>
    ...
    <#if typeId?has_content && typeId=="PERSON">
      ...
      <#if faxNumbers?has_content>  
        <#assign faxNumbers = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByDate(faxNumbers, nowTimestamp, null, null, true)/>
      ...
      <#-- Customer Phone -->
      <#assign partyContactDetails = delegator.findByAnd("PartyContactDetailByPurpose", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("partyId", partyId), null, false)/>
      ...
      <#if partyContactDetails?has_content>
        <#assign partyHomePhoneDetails = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByAnd(partyContactDetails,{"contactMechPurposeTypeId" : "PHONE_HOME"}) />
      </#if>
      <#if partyHomePhoneDetails?has_content>
        ...
        <#-- Work Phone -->
      <#if partyContactDetails?has_content>
        <#assign partyWorkPhoneDetails = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByAnd(partyContactDetails,{"contactMechPurposeTypeId" : "PHONE_WORK"}) />
      </#if>
      <#if partyWorkPhoneDetails?has_content>
        ...
        <#-- Cell Phone --> 
      <#if partyContactDetails?has_content>
        <#assign partyCellPhoneDetails = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByAnd(partyContactDetails,{"contactMechPurposeTypeId" : "PHONE_MOBILE"}) />
      </#if>
    ...
    <#assign partyCustomAttributeListRes = dispatcher.runSync("getPartyCustomAttributeList", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("useCache", "false"))/>
        ...
        <fo:table-row>
          <fo:table-cell>
            <fo:table>
              ...
              <fo:table-body font-size="8pt">
                  <#assign noteList = delegator.findByAnd("PartyNoteView", {"targetPartyId" : partyId!}, null, false)/>
