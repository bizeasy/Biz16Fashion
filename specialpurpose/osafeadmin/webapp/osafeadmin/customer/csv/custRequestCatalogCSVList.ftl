    ...
    <#if custReqAttributeList?exists && custReqAttributeList?has_content>
        <#list custReqAttributeList as custReqAttribute>
          ...
          <#if custReqAttribute.attrName == 'ADDRESS1'>
            <#assign address1 = Static["org.apache.ofbiz.base.util.StringUtil"].replaceString(custReqAttribute.attrValue!"",","," ")/>
            <#assign address1 = Static["org.apache.ofbiz.base.util.StringUtil"].wrapString(address1)/>
          </#if>
          <#if custReqAttribute.attrName == 'ADDRESS2'>
            <#assign address2 = Static["org.apache.ofbiz.base.util.StringUtil"].replaceString(custReqAttribute.attrValue!"",","," ")/>
            <#assign address2 = Static["org.apache.ofbiz.base.util.StringUtil"].wrapString(address2)/>
          </#if>
          <#if custReqAttribute.attrName == 'ADDRESS3'>
            <#assign address3 = Static["org.apache.ofbiz.base.util.StringUtil"].replaceString(custReqAttribute.attrValue!"",","," ")/>
            <#assign address3 = Static["org.apache.ofbiz.base.util.StringUtil"].wrapString(address3)/>
          </#if>
          <#if custReqAttribute.attrName == 'CITY'>
            <#assign city = Static["org.apache.ofbiz.base.util.StringUtil"].replaceString(custReqAttribute.attrValue!"",","," ")/>
            <#assign city = Static["org.apache.ofbiz.base.util.StringUtil"].wrapString(city)/>
          </#if>
          <#if custReqAttribute.attrName == 'STATE_PROVINCE'>
            <#assign state = Static["org.apache.ofbiz.base.util.StringUtil"].replaceString(custReqAttribute.attrValue!"",","," ")/>
            <#assign state = Static["org.apache.ofbiz.base.util.StringUtil"].wrapString(state)/>
          </#if>
          <#if custReqAttribute.attrName == 'ZIP_POSTAL_CODE'>
            <#assign zip = Static["org.apache.ofbiz.base.util.StringUtil"].replaceString(custReqAttribute.attrValue!"",","," ")/>
            <#assign zip = Static["org.apache.ofbiz.base.util.StringUtil"].wrapString(zip)/>
          </#if>
          <#if custReqAttribute.attrName == 'COUNTRY'>
            <#assign country = Static["org.apache.ofbiz.base.util.StringUtil"].replaceString(custReqAttribute.attrValue!"",","," ")/>
          </#if>
