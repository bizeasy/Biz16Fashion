    ...
    <#if custReqAttributeList?exists && custReqAttributeList?has_content>
        <#list custReqAttributeList as custReqAttribute>
          ...
          <#if custReqAttribute.attrName == 'ORDER_NUMBER'>
            <#assign orderNo = Static["org.apache.ofbiz.base.util.StringUtil"].replaceString(custReqAttribute.attrValue!"",","," ")/>
            <#assign orderNo = Static["org.apache.ofbiz.base.util.StringUtil"].wrapString(orderNo)/>
          </#if>
