<#if parameters.organizationCustomerPartyId?has_content>
    <tr class="dataRow odd">
        ...
        <#assign primaryEmail="">
        <#assign partyContactMechValueMaps = Static["org.apache.ofbiz.party.contact.ContactMechWorker"].getPartyContactMechValueMaps(delegator, parameters.organizationCustomerPartyId, false)!""/>
