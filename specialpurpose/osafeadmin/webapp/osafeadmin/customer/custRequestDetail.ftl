<#if custRequest?has_content>
  ...
  <div class="infoRow row">
    <div class="infoEntry long">
      <div class="infoCaption">
        <label>
          <#assign labelName = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", attrNameLname, locale)/>${labelName!}
        </label>
      </div>
  ...
  <div class="infoRow row">
    <div class="infoEntry long">
      <div class="infoCaption">
        <label>
          <#assign labelName = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", attrNameFname, locale)/>${labelName!}
        </label>
      </div>
  ...
  <div class="infoRow row">
    <div class="infoEntry long">
      <div class="infoCaption">
        <label>
          <#assign labelName = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", attrNameAdd1, locale)/>${labelName!}
        </label>
      </div>
  ...
  <#if address2?exists && address2?has_content>
    <div class="infoRow row">
      <div class="infoEntry long">
        <div class="infoCaption">
          <label>
            <#assign labelName = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", attrNameAdd2, locale)/>${labelName!}
          </label>
        </div>
  ...
  <#if address3?exists && address3?has_content>
    <div class="infoRow row">
      <div class="infoEntry long">
        <div class="infoCaption">
          <label>
            <#assign labelName = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", attrNameAdd3, locale)/>${labelName!}
          </label>
        </div>
  ...
  <div class="infoRow row">
    <div class="infoEntry long">
      <div class="infoCaption">
        <label>
          <#assign labelName = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", attrNameCity, locale)/>${labelName!}
        </label>
      </div>
  ...
  <div class="infoRow row">
    <div class="infoEntry long">
      <div class="infoCaption">
        <label>
          <#assign labelName = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", attrNameState, locale)/>${labelName!}
        </label>
      </div>
  ...
  <div class="infoRow row">
    <div class="infoEntry long">
      <div class="infoCaption">
        <label>
          <#assign labelName = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", attrNameZip, locale)/>${labelName!}
        </label>
      </div>
  ...
  <#if country?exists && country?has_content>
    <div class="infoRow row">
      <div class="infoEntry long">
        <div class="infoCaption">
          <label>
            <#assign labelName = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", attrNameCountry, locale)/>${labelName!}
          </label>
        </div>
  ...
  <#if contactUsReason?exists && contactUsReason?has_content>
    <div class="infoRow row">
      <div class="infoEntry long">
        <div class="infoCaption">
          <label>
            <#assign labelName = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", attrNameReason, locale)/>${labelName!}
          </label>
        </div>
  ...
  <div class="infoRow row">
    <div class="infoEntry long">
      <div class="infoCaption">
        <label>
          <#assign labelName = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", attrNameEmail, locale)/>${labelName!}
        </label>
      </div>
  ...
  <#if phone?exists && phone?has_content>
    <div class="infoRow row">
      <div class="infoEntry long">
        <div class="infoCaption">
          <label>
            <#assign labelName = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", attrNamePhone, locale)/>${labelName!}
          </label>
        </div>
        <div class="infoValue">
           ${formattedHomePhone!}
  ...
  <#if partNumber?exists && partNumber?has_content>
    <div class="infoRow row">
      <div class="infoEntry long">
        <div class="infoCaption">
          <label>
            <#assign labelName = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", attrNamePartNumber, locale)/>${labelName!}
          </label>
        </div>
  ...
  <#if orderNo?exists && orderNo?has_content>
    <div class="infoRow row">
      <div class="infoEntry long">
        <div class="infoCaption">
          <label>
            <#assign labelName = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", attrNameOrderNo, locale)/>${labelName!}
          </label>
        </div>
  ...
  <#if comment?exists && comment?has_content>
    <div class="infoRow row">
      <div class="infoEntry long">
        <div class="infoCaption">
          <label>
            <#assign labelName = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", attrNameComment, locale)/>${labelName!}
          </label>
        </div>
  ...
  <div class="infoRow row">
    <div class="infoEntry long">
      <div class="infoCaption">
        <label>
          <#assign labelName = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", attrNameExported, locale)/>${labelName!}
        </label>
      </div>
      <div class="infoValue">
        <#if exported == 'Y'>
  ...
  <div class="infoRow row">
    <div class="infoEntry long">
      <div class="infoCaption">
        <label>
          <#assign labelName = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", attrNameExportedDate, locale)/>${labelName!}
        </label>
      </div>
      <div class="infoValue">
