<#if mode?has_content>
	<#if userInfo?exists && userInfo?has_content>
	  ...
	  <#if mode="edit">
	  	<#assign successFailedLogins = Static["org.apache.ofbiz.base.util.UtilProperties"].getPropertyValue("security.properties", "max.failed.logins")>
	  	<#assign successFailedLoginMap = Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("successFailedLoginsNumber", successFailedLogins)>
      	<#assign successFailedLoginToolTipText = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels","SuccessFailedLoginsHelpInfo",successFailedLoginMap, locale ) />
	  </#if>
	  <div class="infoRow row">
		  <div class="infoEntry long">
		    <div class="infoCaption">
	  ...
	  <#if mode !="add">
		  <#assign successFailedMinutesLogins = Static["org.apache.ofbiz.base.util.UtilProperties"].getPropertyValue("security.properties", "login.disable.minutes")>
		  <#assign successFailedMinutesMap = Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("numberOfminutes", successFailedMinutesLogins)>
	      <#assign successFailedMinutesToolTipText = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels","SuccessFailedNumberMinutesHelpInfo",successFailedMinutesMap, locale ) />
	  ...
	  <#if mode !="add">
	  	<#assign maxFailedLogins = Static["org.apache.ofbiz.base.util.UtilProperties"].getPropertyValue("security.properties", "max.failed.logins")>
		  <#assign maxFailedLoginsMap = Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("maxFailedLogins", maxFailedLogins)>
	      <#assign successiveFailedLoginsToolTipText = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels","MaxFailedLoginsMapHelpInfo",maxFailedLoginsMap, locale ) />
		  <div class="infoRow">
		    <div class="infoEntry">
		      <div class="infoCaption">
