        ...
        <#if resultList?exists && resultList?has_content>
            ...
            <#list resultList as userRow>
            	...
            	<#if securityGroupExpired="false">
            		...
            		<#assign groupIdsStringMap = Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("groupIdsString", groupIdsString)>
            		<#assign userLoginGroupToolTipText = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels","UserSecurityGroupHelpInfo",groupIdsStringMap, locale ) />
