    <#if (pagingListSize?has_content && pagingListSize > 0)>
      ...
      <#if previousParams?has_content>
         <#assign previousParams = Static["org.apache.ofbiz.base.util.UtilHttp"].stripNamedParamsFromQueryString(previousParams,Static["org.apache.ofbiz.base.util.UtilMisc"].toSet("viewSize","viewIndex","rowDeleted"))/>
      </#if>
          ...
          <ul class="pagingLinksBody">
                        ...
                        <#else>
                          <#if parameters.showPagesLink?exists && ((pagingListSize == viewSize) || (parameters.rowDeleted?has_content && parameters.rowDeleted=='Y' && (pagingListSize &gt; ADM_DEF_LIST_ROWS?number))) >
                          	<#if previousParams?has_content>
                          		<#assign previousParams = Static["org.apache.ofbiz.base.util.UtilHttp"].stripNamedParamsFromQueryString(previousParams,Static["org.apache.ofbiz.base.util.UtilMisc"].toSet("preRetrieved"))/>
                          	</#if>
