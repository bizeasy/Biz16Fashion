<#if (pagingListSize?has_content && pagingListSize > 0)>
  ...
  <#if previousParams?has_content>
    <#assign previousParams = Static["org.apache.ofbiz.base.util.UtilHttp"].stripNamedParamsFromQueryString(previousParams,Static["org.apache.ofbiz.base.util.UtilMisc"].toSet("viewSize","viewIndex"))/>
  </#if>
