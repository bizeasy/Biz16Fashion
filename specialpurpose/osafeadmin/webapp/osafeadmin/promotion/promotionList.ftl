  ...
  <thead>
   <tr class="heading">
    ...
    <#if resultList?exists && resultList?has_content>
        ...
        <#assign orderByList = Static["org.apache.ofbiz.base.util.UtilMisc"].toList("productPromoId","promoName")/>
        <#assign resultList = Static["org.apache.ofbiz.entity.util.EntityUtil"].orderBy(resultList,orderByList) />
        <#list resultList as productPromo>
          <#if productPromo.productStoreId?has_content>
            <#assign isProductStorePromoActive = Static["org.apache.ofbiz.entity.util.EntityUtil"].isValueActive(productPromo,Static["org.apache.ofbiz.base.util.UtilDateTime"].nowTimestamp(), "productStorePromoApplFromDate", "productStorePromoApplThruDate")/>
          </#if>
          <#if productPromo.productPromoCodeId?has_content>
            <#assign isProductPromoCodeActive = Static["org.apache.ofbiz.entity.util.EntityUtil"].isValueActive(productPromo,Static["org.apache.ofbiz.base.util.UtilDateTime"].nowTimestamp(), "productPromoCodeFromDate", "productPromoCodeThruDate")/>
          </#if>
          ...
          <#assign hasNext = productPromo_has_next>
            <tr class="dataRow <#if rowClass == "2">even<#else>odd</#if>">
                ...
                <td class="dateCol <#if !hasNext>lastRow</#if>"><#if !alreadyShownProductPromoIdList.contains(productPromo.productPromoId!"")>${Static["org.apache.ofbiz.base.util.UtilDateTime"].toDateString(productPromo.productStorePromoApplFromDate,preferredDateFormat)!""}<#--${(productPromo.productStorePromoApplFromDate?string("'"+preferredDateFormat+"'"))!""}--></#if></td>
                <td class="dateCol <#if !hasNext>lastRow</#if>"><#if !alreadyShownProductPromoIdList.contains(productPromo.productPromoId!"")>${Static["org.apache.ofbiz.base.util.UtilDateTime"].toDateString(productPromo.productStorePromoApplThruDate,preferredDateFormat)!""}<#--${(productPromo.productStorePromoApplThruDate?string("'"+preferredDateFormat+"'"))!""}--></#if></td>
                ...
                <td class="dateCol <#if !hasNext>lastRow</#if>">${Static["org.apache.ofbiz.base.util.UtilDateTime"].toDateString(productPromo.productPromoCodeFromDate,preferredDateFormat)!""}<#--${(productPromo.productPromoCodeFromDate?string("'"+preferredDateFormat+"'"))!""}--></td>
                <td class="dateCol <#if !hasNext>lastRow</#if>">${Static["org.apache.ofbiz.base.util.UtilDateTime"].toDateString(productPromo.productPromoCodeThruDate,preferredDateFormat)!""}<#--${(productPromo.productPromoCodeThruDate?string("'"+preferredDateFormat+"'"))!""}--></td>
                ...
                <td class="actionPromoCol <#if !hasNext>lastRow</#if> lastCol">
                    <#assign tooltipData = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", "AddPromoCodeInfo", Static["org.apache.ofbiz.base.util.UtilMisc"].toList(productPromo.promoName!""), locale)/>
