                ...
                <#if statusId == "CTNT_PUBLISHED" >
                    <#assign lastModifiedDate = "" />
              		<#if thisContent.lastModifiedDate?has_content>
                        <#--${thisContent.lastModifiedDate?string("'"+preferredDateFormat+"'")}-->${Static["org.apache.ofbiz.base.util.UtilDateTime"].toDateString(thisContent.lastModifiedDate,preferredDateFormat)}
              		</#if>
                </#if>
            </td>
