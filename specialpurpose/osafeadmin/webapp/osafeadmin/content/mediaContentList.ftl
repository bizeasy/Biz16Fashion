...
<#if resultList?exists && resultList?has_content>
  ...
  <#list resultList as fileName>
    <tr class="dataRow <#if rowClass?if_exists == "2">even<#else>odd</#if>">
      ...
      <td class="actionCol">
        <#assign deleteMediaAssetConfirmText = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", "DeleteMediaAssetConfirmListText", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("fileName", "${fileName?html}"), locale)/>
