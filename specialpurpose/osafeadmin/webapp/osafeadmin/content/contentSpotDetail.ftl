<#if mode?has_content>
    ...
    <input type="hidden" name="contentTypeId" value="${contentTypeId!content.contentTypeId!""}" />
       ...
       <#if !(createdDate?has_content)>
           <#assign createdDate = Static["org.apache.ofbiz.base.util.UtilDateTime"].nowTimestamp() />
       </#if>
	    ...
	    <div class="infoRow CONTEXT_FILE">
	   		<div class="infoEntry long">
     		    ...
     		    <div class="infoIcon">
     		        ...
     		        <#assign tooltipData = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", "FileReferenceContentHelpInfo", Static["org.apache.ofbiz.base.util.UtilMisc"].toList("${ofbizHome}/specialpurpose/osafe/webapp/osafe"), locale)/>
