  ...
  <thead>
    ...
    <#if resultList?exists && resultList?has_content>
        ...
        <#list resultList as priceRule>
            ...
            <#assign isPriceRuleActive = Static["org.apache.ofbiz.entity.util.EntityUtil"].isValueActive(priceRule,Static["org.apache.ofbiz.base.util.UtilDateTime"].nowTimestamp(), "fromDate", "thruDate")/>
            <tr class="dataRow <#if rowClass == "2">even<#else>odd</#if>">
                ...
                <td class="dateCol <#if !hasNext>lastRow</#if>"><#--${(priceRule.fromDate?string("'"+preferredDateFormat+"'"))!""}-->${Static["org.apache.ofbiz.base.util.UtilDateTime"].toDateString(priceRule.fromDate,preferredDateFormat)}</td>
                <td class="dateCol <#if !hasNext>lastRow</#if>"><#--${(priceRule.thruDate?string("'"+preferredDateFormat+"'"))!""}-->${Static["org.apache.ofbiz.base.util.UtilDateTime"].toDateString(priceRule.thruDate,preferredDateFormat)}</td>
