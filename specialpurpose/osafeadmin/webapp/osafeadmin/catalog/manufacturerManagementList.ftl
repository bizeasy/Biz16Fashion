            ...
            <#list resultList as partyRow>
                  ...
                  <tr class="dataRow <#if rowClass == "2">even<#else>odd</#if>">
                   ...
                   <#if partyContentWrapper?has_content>
                     <#assign manufacturerProfileName = partyContentWrapper.get("PROFILE_NAME", false,"html")/> 
                     <#assign manufacturerShortDescription = partyContentWrapper.get("DESCRIPTION", false,"html")/> 
                     <#assign manufacturerLongDescription = partyContentWrapper.get("LONG_DESCRIPTION", false,"html")/> 
                   </#if>
