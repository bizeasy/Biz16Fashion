        ...
        <div class="infoEntry">
            ...
            <div class="infoValue" id="primaryParentCategoryName">
                <#if parentProductCategoryId?exists>
                    <#assign productCategory = delegator.findOne("ProductCategory", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("productCategoryId", parentProductCategoryId?if_exists), false)/>
                    ${productCategory.categoryName!parameters.primaryParentCategoryId?if_exists}
                </#if>
            </div>
            <#if topLevelList?has_content><#assign topCategoryList = Static["org.apache.ofbiz.entity.util.EntityUtil"].getFieldListFromEntityList(topLevelList, "productCategoryId", true)></#if>
