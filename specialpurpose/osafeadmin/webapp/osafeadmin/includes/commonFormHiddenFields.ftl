 ...
 <input type="hidden" name="entryDateFormat" value="${globalContext.entryDateFormat!""}" />
 <input type="hidden" name="entryDateTimeFormat" value="${globalContext.entryDateTimeFormat!""}" />
