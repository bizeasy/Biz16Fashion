...
<#elseif (mode?has_content && mode == "edit") && (isVirtual = 'Y' || isFinished = 'Y')>
    <#if prodCatList?exists>
        <#list prodCatList as productCategoryAndMember>
            ...
            <#assign primaryProdCategory = delegator.findOne("ProductCategory", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("productCategoryId", productCategoryAndMember.primaryParentCategoryId?if_exists), false)/>
