  ...
  <div class="boxBody">
    <#if product?has_content>
      <#if productContentWrapper?exists>
        <#assign plpSwatchImageURL = productContentWrapper.get("PLP_SWATCH_IMAGE_URL", "url")!""/>
        <#assign pdpSwatchImageURL = productContentWrapper.get("PDP_SWATCH_IMAGE_URL", "url")!""/>
      </#if>
