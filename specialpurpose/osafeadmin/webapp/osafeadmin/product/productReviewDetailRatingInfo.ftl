<#if review?has_content>
    ...
    <#assign overallRatingDir=Static["org.apache.ofbiz.base.util.UtilFormatOut"].replaceString(""+overallRating,".","_")/>
    ...
    <#assign qualityRatingDir=Static["org.apache.ofbiz.base.util.UtilFormatOut"].replaceString(""+qualityRating,".","_")/>
    ...
    <#assign effectivenessRatingDir=Static["org.apache.ofbiz.base.util.UtilFormatOut"].replaceString(""+effectivenessRating,".","_")/>
    ...
    <#assign satisfactionRatingDir=Static["org.apache.ofbiz.base.util.UtilFormatOut"].replaceString(""+satisfactionRating,".","_")/>
