  ...
  <#if resultList?exists && resultList?has_content>
    ...
    <#list resultList as result>
      ...
      <tr class="dataRow <#if rowClass?if_exists == "2">even<#else>odd</#if>">
        ...
        <td class="dateCol <#if !hasNext?if_exists>lastRow</#if>"><#--${(product.introductionDate?string("'"+preferredDateFormat+"'"))!""}-->${Static["org.apache.ofbiz.base.util.UtilDateTime"].toDateString(product.introductionDate,preferredDateFormat)}</td>
        <td class="dateCol <#if !hasNext?if_exists>lastRow</#if>"><#--${(product.salesDiscontinuationDate?string("'"+preferredDateFormat+"'"))!""}-->${Static["org.apache.ofbiz.base.util.UtilDateTime"].toDateString(product.salesDiscontinuationDate,preferredDateFormat)}</td>
              ...
              <div class="actionIcon">
                ...
                <ul>
                 ...
                 <#elseif (product.productTypeId?if_exists == 'FINISHED_GOOD') && (product.isVirtual?if_exists == 'N') && (product.isVariant?if_exists == 'N')>
                  ...
                  <#if (product.isVirtual?if_exists == 'Y')>
                    <#assign prodVariants = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByAnd(productAssocs,Static["org.apache.ofbiz.base.util.UtilMisc"].toMap('productAssocTypeId','PRODUCT_VARIANT'))/>
                  ...
                  <#if (product.isVariant?if_exists == 'N')>
                    <#assign prodRelatedComplement = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByAnd(productAssocs,Static["org.apache.ofbiz.base.util.UtilMisc"].toMap('productAssocTypeId','PRODUCT_COMPLEMENT'))/>
                    <#assign prodRelatedComplement = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByDate(prodRelatedComplement) />
                    <#assign prodRelatedComplementCount = prodRelatedComplement.size()!0/>
                    <#assign prodRelatedAccessory = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByAnd(productAssocs,Static["org.apache.ofbiz.base.util.UtilMisc"].toMap('productAssocTypeId','PRODUCT_ACCESSORY'))/>
                    <#assign prodRelatedAccessory = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByDate(prodRelatedAccessory) />
                  ...
                  <#if (product.productTypeId?if_exists == 'FINISHED_GOOD') && (product.isVirtual?if_exists == 'N')>
                    ...
                    <#if product.introductionDate?has_content>
                      ...
                      <#--<#assign introductionDate = (introDate)?string("'"+preferredDateFormat+"'")>--><#assign introductionDate = Static["org.apache.ofbiz.base.util.UtilDateTime"].toDateString(introDate,preferredDateFormat)>
                    ...
                    <#if product.salesDiscontinuationDate?has_content>
                      ...
                      <#--<#assign salesDiscontinuationDate = (discDate)?string("'"+preferredDateFormat+"'")>--><#assign salesDiscontinuationDate = Static["org.apache.ofbiz.base.util.UtilDateTime"].toDateString(discDate,preferredDateFormat)>
                    ...
                    <#else>
                      <#if inventoryMethod?has_content && inventoryMethod.toUpperCase() == "BIGFISH" >
                        ...
                        <#if bfProductAllAttributes?has_content>
                          ...
                          <#assign bfWHInventoryProductAttributes = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByAnd(bfProductAllAttributes,Static["org.apache.ofbiz.base.util.UtilMisc"].toMap('attrName','BF_INVENTORY_WHS'))/>
                        </#if>
                        <#if bfTotalInventoryProductAttributes?has_content>
                          <#assign bfTotalInventoryProductAttribute = Static["org.apache.ofbiz.entity.util.EntityUtil"].getFirst(bfTotalInventoryProductAttributes) />
