            ...
            <#list productReviews as review>
              ...
              <#assign ratePercentage= ((rating / 5) * 100)>
                <tr class="dataRow <#if rowClass == "2">even<#else>odd</#if>">
                    ...
                    <#assign postedInterval = Static["org.apache.ofbiz.base.util.UtilDateTime"].getIntervalInDays(Static["org.apache.ofbiz.base.util.UtilDateTime"].getDayStart(review.postedDateTime), Static["org.apache.ofbiz.base.util.UtilDateTime"].getDayEnd(nowTimestamp))/>
