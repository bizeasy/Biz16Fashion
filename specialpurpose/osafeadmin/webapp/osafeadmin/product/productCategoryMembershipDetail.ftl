  ...
  <tbody>
    ...
    <#if resultList?exists && resultList?has_content && !parameters.totalRows?exists>
        <#list resultList as productCategoryAndMember>
            <#assign primaryProductCategory = delegator.findOne("ProductCategory", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("productCategoryId", productCategoryAndMember.primaryParentCategoryId?if_exists), false)?if_exists/>
            <tr class="dataRow <#if rowClass?if_exists == "2">even<#else>odd</#if>">
               ...
               <td class="actionCol">
                   <#assign productCategoryAndMemberCategoryName = Static["org.apache.ofbiz.osafe.util.OsafeAdminUtil"].formatSimpleText('${productCategoryAndMember.categoryName!}') />
    ...
    <#elseif parameters.totalRows?exists>
        ...
        <#list 1..minRow as x>
            ...
            <#assign productCategory = delegator.findOne("ProductCategory", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("productCategoryId", productCategoryMemberId?if_exists), false)?if_exists/>
            <#assign primaryProductCategory = delegator.findOne("ProductCategory", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("productCategoryId", productCategory.primaryParentCategoryId?if_exists), false)?if_exists/>
            <tr class="dataRow <#if rowClass?if_exists == "2">even<#else>odd</#if>">
