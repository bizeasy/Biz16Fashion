          ...
          <div class="infoEntry">
            ...
            <div class="infoValue">
              <select id="selectableProductFeature_${selFeatureType}" name="selectableProductFeature_${selFeatureType}" class="short">
                ...
                <#assign selectedFetureParm = Static["org.apache.ofbiz.base.util.StringUtil"].wrapString(parameters.get("selectableProductFeature_${selFeatureType}"))!"" />
                <#list productFeatureList as productFeature>
                  <#assign selectedFetureDb = "" />
                    
                    <#if variantProductStandardFeatureAndAppls?has_content>
                      <#assign variantProductFeatureAndAppls = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByAnd(variantProductStandardFeatureAndAppls,Static["org.apache.ofbiz.base.util.UtilMisc"].toMap('productFeatureId',productFeature.productFeatureId!, 'productFeatureTypeId', selFeatureType))/>
                      <#if variantProductFeatureAndAppls?has_content>
                        <#assign variantProductFeatureAndAppl = Static["org.apache.ofbiz.entity.util.EntityUtil"].getFirst(variantProductFeatureAndAppls) />
          ...
          <div class="infoEntry">
            ...
            <div class="infoValue" id="distinguishFeatureValue_${descFeatureType}">
              ...
              <#if variantProductDescFeatureAndAppls?has_content>
                  <#assign variantProductDescFeatureAndApplsByType = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByAnd(variantProductDescFeatureAndAppls,Static["org.apache.ofbiz.base.util.UtilMisc"].toMap('productFeatureTypeId', descFeatureType))/>
              </#if>
            ...
            <input type="hidden" name="distinguishProductFeatureNameMulti_${descFeatureType}" id="distinguishProductFeatureNameMulti_${descFeatureType}" value=""/>
              ...
              <select id="distinguishProductFeature_${descFeatureType}" name="distinguishProductFeature_${descFeatureType}" class="short" <#if distinguishProductFeatureMultiValue?has_content>style="display:none"</#if> >
                <option value="">Select</option>
                <#assign descFetureParm = Static["org.apache.ofbiz.base.util.StringUtil"].wrapString(parameters.get("distinguishProductFeature_${descFeatureType}"))!"" />
                <#-- assign selectedFeture = selectedFeture.substring(0, selectedFeture.indexOf('@')) / -->
                <#list productFeatureList as productFeature>
                  <#assign descFetureDb = "" />
                  
                    <#if variantProductDescFeatureAndAppls?has_content>
                      <#assign variantProductFeatureAndAppls = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByAnd(variantProductDescFeatureAndAppls,Static["org.apache.ofbiz.base.util.UtilMisc"].toMap('productFeatureId',productFeature.productFeatureId!, 'productFeatureTypeId', descFeatureType))/>
                      <#if variantProductFeatureAndAppls?has_content>
                        <#assign variantProductFeatureAndAppl = Static["org.apache.ofbiz.entity.util.EntityUtil"].getFirst(variantProductFeatureAndAppls) />
