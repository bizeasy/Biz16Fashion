          ...
          <div class="infoEntry long">
            ...
            <div class="infoValue">
              <#if currentProduct?has_content>
                  <#assign goodIdentification = delegator.findOne("GoodIdentification", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("goodIdentificationTypeId" , goodIdentificationTypeId, "productId" , currentProduct.productId!),false)?if_exists/>
              </#if>
            ...
            <#if (variantProduct?has_content && mode=="edit") || (virtualProduct?has_content && mode=="add")>
              <#if virtualProduct?has_content>
                  <#assign virtualGoodIdentification = delegator.findOne("GoodIdentification", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("goodIdentificationTypeId" , goodIdentificationTypeId, "productId" , virtualProduct.productId!),false)?if_exists/>
              </#if>
              ...
              <div class="infoIcon">
                <#if virtualIdValue?has_content>
                  <#assign tooltipData = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", "VirtualIdentificationInfo", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("idType", "${goodIdentificationType.get('description','OSafeAdminUiLabels',locale)}", "idValue","${virtualIdValue}"), locale)/>
                <#else>
                  <#assign tooltipData = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", "VirtualIdentificationBlankInfo",Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("idType", "${goodIdentificationType.get('description','OSafeAdminUiLabels',locale)}"), locale)/>
                </#if>
...
<#elseif mode?has_content && mode == "edit" && isVirtual=='Y'>
        <#if bfProductAllAttributes?has_content>
            <#assign bfMultiSelectVariantsProductAttributes = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByAnd(bfProductAllAttributes,Static["org.apache.ofbiz.base.util.UtilMisc"].toMap('attrName','PDP_SELECT_MULTI_VARIANT'))/> 
        </#if>
        <#if bfMultiSelectVariantsProductAttributes?has_content>
            <#assign bfMultiSelectVariantsProductAttribute = Static["org.apache.ofbiz.entity.util.EntityUtil"].getFirst(bfMultiSelectVariantsProductAttributes) />
...
<#if (mode?has_content) && !(mode == "edit" && isVirtual=='Y' && isVariant=='N')>
    <#if bfProductAllAttributes?has_content>
        <#assign productGiftMessageAttributes = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByAnd(bfProductAllAttributes,Static["org.apache.ofbiz.base.util.UtilMisc"].toMap('attrName','CHECKOUT_GIFT_MESSAGE'))/> 
    </#if>
    <#if productGiftMessageAttributes?has_content>
        <#assign productGiftMessageAttribute = Static["org.apache.ofbiz.entity.util.EntityUtil"].getFirst(productGiftMessageAttributes) />
    ...
    <div class="infoRow row buyableProductAttribute">
        <div class="infoEntry">
            ...
            <div class="infoIcon">
                <#assign tooltipData = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", "ProductCheckoutGiftMessageInfo", [CHECKOUT_GIFT_MESSAGE!], locale)/>
                <a class="helper" href="javascript:void(0);" onMouseover="showTooltip(event,'${tooltipData!""}');" onMouseout="hideTooltip()"><span class="helperIcon"></span></a>
            </div>
        </div>
    </div>
	...
	<#if bfProductAllAttributes?has_content>
        <#assign productPdpQuantityMinAttributes = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByAnd(bfProductAllAttributes,Static["org.apache.ofbiz.base.util.UtilMisc"].toMap('attrName','PDP_QTY_MIN'))/> 
        <#if productPdpQuantityMinAttributes?has_content>
	        <#assign productPdpQuantityMinAttribute = Static["org.apache.ofbiz.entity.util.EntityUtil"].getFirst(productPdpQuantityMinAttributes) />
    ...
    <div class="infoRow row buyableProductAttribute">
       <div class="infoEntry">
           ...
           <div class="infoIcon">
               <#assign tooltipData = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", "PdpQtyMinTooltip", [PDP_QTY_MIN!], locale)/>
               <a class="helper" href="javascript:void(0);" onMouseover="showTooltip(event,'${tooltipData!""}');" onMouseout="hideTooltip()"><span class="helperIcon"></span></a>
           </div>
       </div>
    </div>
    ...
    <#if bfProductAllAttributes?has_content>
        <#assign productPdpQuantityMaxAttributes = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByAnd(bfProductAllAttributes,Static["org.apache.ofbiz.base.util.UtilMisc"].toMap('attrName','PDP_QTY_MAX'))/> 
        <#if productPdpQuantityMaxAttributes?has_content>
	        <#assign productPdpQuantityMaxAttribute = Static["org.apache.ofbiz.entity.util.EntityUtil"].getFirst(productPdpQuantityMaxAttributes) />
    ...
    <div class="infoRow row buyableProductAttribute">
       <div class="infoEntry">
           ...
           <div class="infoIcon">
               <#assign tooltipData = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", "PdpQtyMaxTooltip", [PDP_QTY_MAX!], locale)/>
               <a class="helper" href="javascript:void(0);" onMouseover="showTooltip(event,'${tooltipData!""}');" onMouseout="hideTooltip()"><span class="helperIcon"></span></a>
           </div>
       </div>
    </div>
    ...
    <#if bfProductAllAttributes?has_content>
        <#assign productPdpQuantityDefaultAttributes = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByAnd(bfProductAllAttributes,Static["org.apache.ofbiz.base.util.UtilMisc"].toMap('attrName','PDP_QTY_DEFAULT'))/> 
        <#if productPdpQuantityDefaultAttributes?has_content>
	        <#assign productPdpQuantityDefaultAttribute = Static["org.apache.ofbiz.entity.util.EntityUtil"].getFirst(productPdpQuantityDefaultAttributes) />
    ...
    <div class="infoRow row buyableProductAttribute">
        <div class="infoEntry">
            ...
            <div class="infoIcon">
                <#assign tooltipData = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", "PdpQtyDefaultTooltip", [PDP_QTY_DEFAULT!], locale)/>
                <a class="helper" href="javascript:void(0);" onMouseover="showTooltip(event,'${tooltipData!""}');" onMouseout="hideTooltip()"><span class="helperIcon"></span></a>
            </div>
       </div>
    </div>
