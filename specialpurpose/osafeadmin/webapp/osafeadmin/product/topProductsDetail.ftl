<script language="javascript">
    jQuery(document).ready(function() { 
        ...
        <#assign topProductsList = Static["org.apache.ofbiz.entity.util.EntityUtil"].orderBy(topProductsList,Static["org.apache.ofbiz.base.util.UtilMisc"].toList("unitPrice DESC")) />
        <#assign totItem = 0/>
        <#assign totSales = 0/>
          <thead>
          <tr class="heading">
