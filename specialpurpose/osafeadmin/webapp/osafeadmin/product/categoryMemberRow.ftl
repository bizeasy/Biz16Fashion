<#if parameters.productCategoryId?has_content>
    <#assign productCategory = delegator.findOne("ProductCategory", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("productCategoryId", parameters.productCategoryId?if_exists), false)?if_exists/>
