   ...
   <#else>
       <div class="infoRow column">
        <div class="infoEntry">
          ...
          <div class="infoIcon">
              <#assign tooltipData = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", "VariantListPriceInfo", Static["org.apache.ofbiz.base.util.UtilMisc"].toList("${globalContext.currencySymbol!}${listPrice!}"), locale)/>
    ...
    <#else>
      <div class="infoRow column">
        <div class="infoEntry">
          ...
          <div class="infoIcon">
              <#assign tooltipData = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", "VariantSalePriceInfo", Static["org.apache.ofbiz.base.util.UtilMisc"].toList("${globalContext.currencySymbol!}${defaultPrice!}"), locale)/>
              <a href="javascript:void(0);" onMouseover="showTooltip(event,'${tooltipData!""}');" onMouseout="hideTooltip()"><span class="helperIcon"></span></a>
          </div>
        </div>
        <#if productPriceCondList?has_content><span class="pricingInfo">${uiLabelMap.PricingRulesApplyInfo}</span></#if>
   ...
   <#if (mode?has_content && mode =='edit' && isVariant != 'Y') || (mode?has_content && mode =='add' && !virtualProduct?has_content)>
     ...
     <!-- Place Holder for Variant Recurrence Price
      <div class="infoRow column">
        <div class="infoEntry">
          ...
          <div class="infoIcon">
              <#assign tooltipData = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", "VariantRecurringPriceInfo", Static["org.apache.ofbiz.base.util.UtilMisc"].toList("${globalContext.currencySymbol!}${recurringPrice!}"), locale)/>
              <a href="javascript:void(0);" onMouseover="showTooltip(event,'${tooltipData!""}');" onMouseout="hideTooltip()"><span class="helperIcon"></span></a>
          </div>
        </div>
      </div>
    ...
    <#if (currentProduct?exists) && (mode?has_content)>
      ...
      <#if bfProductAllAttributes?has_content>
        ...
        <#assign pdpInStoreOnlyProductAttributes = Static["org.apache.ofbiz.entity.util.EntityUtil"].filterByAnd(bfProductAllAttributes,Static["org.apache.ofbiz.base.util.UtilMisc"].toMap('attrName','PDP_IN_STORE_ONLY'))/>
      </#if>
      ...
      <#if bfWHInventoryProductAttributes?has_content>
        <#assign bfWHInventoryProductAttribute = Static["org.apache.ofbiz.entity.util.EntityUtil"].getFirst(bfWHInventoryProductAttributes) />
        <#assign bfWHInventory = bfWHInventoryProductAttribute.attrValue!>
      </#if>
      
      <#if pdpInStoreOnlyProductAttributes?has_content>
        <#assign pdpInStoreOnlyProductAttribute = Static["org.apache.ofbiz.entity.util.EntityUtil"].getFirst(pdpInStoreOnlyProductAttributes) />
