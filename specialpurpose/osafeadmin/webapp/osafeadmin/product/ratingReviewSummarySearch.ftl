...
<div class="entryRow">
  <div class="entry daterange">
    ...
    <div class="entryInput from">
      <input class="dateEntry" type="text" name="dateFrom" maxlength="40" value="${parameters.dateFrom!dateFrom!weekStart?string("'"+entryDateTimeFormat+"'")!""}"/>
    </div>
    <label class="tolabel">${uiLabelMap.ToCaption}</label>
    <div class="entryInput to">
      <input class="dateEntry" type="text" name="dateTo" maxlength="40" value="${parameters.dateTo!dateTo!nowTimestamp?string("'"+entryDateTimeFormat+"'")!""}"/>
    </div>
  </div>
