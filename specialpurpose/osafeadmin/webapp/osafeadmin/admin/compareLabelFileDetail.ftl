  ...
  <div class="infoRow">
    <div class="infoEntry">
      ...
      <div class="infoValue">
        <#assign compareYourLabelFile = Static["org.apache.ofbiz.base.util.UtilProperties"].getPropertyValue("osafeAdmin.properties", "ecommerce-deployment-UiLabel-xml-file")>
