        ...
        <td class="actionColSmall">
          <#if compareDivResult.type?has_content>
            <#if compareDivResult.type == "2" && compareDivResult.key?has_content>
              <#assign keyMap = Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("key", compareDivResult.key)>
            ...
            <#if compareDivResult.type == "3" && compareDivResult.key?has_content && valuesMatch == "false">
              <#assign keyMap = Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("key", compareDivResult.key, "value", valueCompareToLabelFile)>
