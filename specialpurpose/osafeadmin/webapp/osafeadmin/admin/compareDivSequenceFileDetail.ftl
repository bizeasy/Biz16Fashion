  ...
  <div class="infoRow">
    <div class="infoEntry">
      ...
      <div class="infoValue">
        <#assign compareYourDivSequenceFile = Static["org.apache.ofbiz.base.util.UtilProperties"].getPropertyValue("osafeAdmin.properties", "osafe-deployment-uiSequence-xml-file")>
