  ...
  <#if feedsOutDir?has_content>
    <#assign currentDateString = Static["org.apache.ofbiz.base.util.UtilDateTime"].nowDateString("yyyyMMdd") />
    <#assign currentTimeString = Static["org.apache.ofbiz.base.util.UtilDateTime"].nowDateString("HHmmss") />
