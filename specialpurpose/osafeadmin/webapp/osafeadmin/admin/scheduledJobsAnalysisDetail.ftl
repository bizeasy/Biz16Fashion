            ...
            <#list jobStatusAnalysisList as jobType>
                ...
                <tr class="dataRow <#if rowClass == "2">even<#else>odd</#if>">
                     ...
                     <td class="seqCol <#if !hasNext>lastRow</#if>">
                        ...
                        <#assign finishDateTime = Static["org.apache.ofbiz.base.util.UtilDateTime"].addDaysToTimestamp(Static["org.apache.ofbiz.base.util.UtilDateTime"].nowTimestamp(), -30)>
                ...
                <#if jobType.result?has_content>
                    <#list jobType.result as result>
                        <tr class="dataRow <#if rowClass == "2">even<#else>odd</#if>">
                             ...
                             <td class="actionCol <#if !hasNext>lastRow</#if>"></td>
                             <td class="actionCol">
                                 <#assign deleteConfirmTxt = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", "DeleteScheduledJobsConfirmText", [result.count, result.serviceName, jobType.status.toUpperCase()], locale)>
                                 <#if jobType.status.equalsIgnoreCase(uiLabelMap.FinishedExclLabel)>
