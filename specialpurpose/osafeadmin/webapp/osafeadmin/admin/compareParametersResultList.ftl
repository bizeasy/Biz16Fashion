        ...
        <td class="actionColSmall <#if !hasNext?if_exists>lastRow</#if>">
          <#if compareParamResult.type?has_content>
            <#if compareParamResult.type == "2" && compareParamResult.key?has_content>
              <#assign keyMap = Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("key", compareParamResult.key)>
              <#assign addParamKeyTooltip = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels","AddParamKeyTooltip",keyMap, locale ) />
            ...
            <#if compareParamResult.type == "3" && compareParamResult.key?has_content && valuesMatch == "false">
              <#assign keyMap = Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("key", compareParamResult.key, "value", valueCompareToParamFile)>
              <#assign addParamKeyTooltip = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels","SyncKeyAndValueTooltip",keyMap, locale ) />
