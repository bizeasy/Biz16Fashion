  ...
  <tr class="heading">
    ...
    <#if (maxSelectableFeatureFile > 0)>
        <#list 1..maxSelectableFeatureFile as selFeatureNo>
            <th class="nameCol">
                ${Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", "SelectableFeaturesNoLabel", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("selFeatureNo", selFeatureNo), locale)!} 
            </th>
        </#list>
    </#if>
    <#if (maxDescriptiveFeatureFile > 0)>
        <#list 1..maxDescriptiveFeatureFile as descFeatureNo>
            <th class="nameCol">
                ${Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", "DescriptiveFeaturesNoLabel", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("descFeatureNo", descFeatureNo), locale)!} 
            </th>
        </#list>
    </#if>
    ...
    <#if (maxAltImages > 0)>
        <#list 1..maxAltImages as imageNo>
            <th class="nameCol">
                ${Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", "PDPAltThumbnailImageLabel", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("thumbImageNo", imageNo), locale)!} 
            </th>
            <th class="nameCol">
                ${Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", "PDPAltRegularImageLabel", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("largeImageNo", imageNo), locale)!} 
            </th>
            <th class="nameCol">
                ${Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", "PDPAltLargeImageLabel", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("detailImageNo", imageNo), locale)!} 
            </th>
        </#list>
    </#if>
