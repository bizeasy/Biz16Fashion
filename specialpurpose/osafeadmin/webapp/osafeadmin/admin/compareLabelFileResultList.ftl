        ...
        <td class="actionColSmall">
          <#if compareLabelResult.type?has_content>
            <#if compareLabelResult.type == "2" && compareLabelResult.key?has_content>
              <#assign keyMap = Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("key", compareLabelResult.key)>
              <#assign addKeyTooltipText = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels","AddKeyTooltip",keyMap, locale ) />
            ...
            <#if compareLabelResult.type == "3" && compareLabelResult.key?has_content && valuesMatch == "false">
              <#assign keyMap = Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("key", compareLabelResult.key, "value", valueCompareToLabelFile)>
              <#assign addKeyTooltipText = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels","SyncKeyAndValueTooltip",keyMap, locale ) />
