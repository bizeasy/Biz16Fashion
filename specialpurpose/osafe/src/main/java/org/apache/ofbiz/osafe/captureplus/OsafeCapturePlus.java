package org.apache.ofbiz.osafe.captureplus;
...
public class OsafeCapturePlus {
    ...
    protected List<String> pcaApiKeyList = new LinkedList<String>();
    protected List<String> pcaApiAppNoList = new LinkedList<String>();

    private List<OsafeCapturePlusUseInfo> osafeCapturePlusUseInfoList = new LinkedList<OsafeCapturePlusUseInfo>();
