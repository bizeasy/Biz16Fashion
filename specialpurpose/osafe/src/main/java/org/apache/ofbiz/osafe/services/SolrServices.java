...
import org.apache.ofbiz.osafe.util.SerializationUtils;
...
public class SolrServices {
    ...
    public static Map genProductsIndex(DispatchContext dctx, Map context) throws GenericTransactionException 
    {
        ...
        List<ProductDocument> documentList = new LinkedList<ProductDocument>();
        
        List<String> headerColumns = getHeaderColumns();

        List<CellProcessor> cellProcessors = getCellProcesser();
        
        List<String> prodFeatureColNames = new LinkedList<String>();
        ...
        try 
        {
            ...
            Set productFeatureCatGrpApplFieldSet = new HashSet<>();
                                ...
                                if (ProductWorker.isSellable(product)) 
                                {
                                    ...
                                    for (String productFeatureType : productFeatureTypes) 
                                    {
                                        ...
                                        try 
                                        {
                                            ...
                                            Map<String, String> featureValuesMap = new HashMap<String, String>();
                                            List<String> featureValues = new LinkedList<String>();
                                            try 
                                            {
                                   ...
                                   List productFacilityIdList = new LinkedList<>();
                                   ...
                                   rollups = EntityUtil.filterByDate(rollups);
                                    ...
                                    for (GenericValue productCategory : currentProductCategories) 
                                    {
                                        ...
                                        {
                                            productFeatureTypeMap = new HashMap<String, String>();
	...
	private static List<CellProcessor> getCellProcesser() {
		List<CellProcessor> cellProcessors = new LinkedList<CellProcessor>();
     ...
     * and service retrive these keys, values from org.apache.ofbiz.osafe.solr.SolrConstants java file
     */
    ...
    public static Map genProductsIndexUpdate(DispatchContext dctx, Map context) throws GenericTransactionException
    {
        ...
        LocalDispatcher dispatcher = dctx.getDispatcher();
        List<ProductDocument> documentList = new LinkedList<ProductDocument>();
        List<ProductDocument> documentListExisting = new LinkedList<ProductDocument>();
