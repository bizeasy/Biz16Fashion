...
import org.apache.ofbiz.osafe.services.SolrIndexDocument;
import org.apache.ofbiz.osafe.solr.CommandContext;
import org.apache.ofbiz.osafe.solr.GenericRefinement;
import org.apache.ofbiz.osafe.solr.RefinementsHelperSolr;
...
public class SolrEvents 
{
    ...
    public static String solrSearch(HttpServletRequest request, HttpServletResponse response) 
    {
        try 
        {
            ...
            Map<String, String> mProductStoreParms = new HashMap<String, String>();
            List<String> facetGroups = new LinkedList<String>();
            Map<String, String> facetGroupDescriptions = new HashMap<String, String>();
            Map<String, String> facetGroupIds = new HashMap<String, String>();
            ...
            Map<String, List> filterGroupParamMap = new HashMap<String, List>();
            ...
            try 
            {
                ...
                List<String> facetCatGroups = new LinkedList<String>();
                Map<String, String> facetCatGroupDescriptions = new HashMap<String, String>();
            ...
            List<Map<String,String>> sortOptions = new LinkedList<Map<String,String>>();
                ...
                for (String sortOption: SORT_OPTIONS_LIST) 
                {
                    ...
                    if(OSAFE_PROPS.containsKey(sortOption))
                    {
                        ...
                        if (UtilValidate.isNotEmpty(sortOptionTxt))
                        {
                            ...
                            {
                                Map<String,String> sortOptionMap = new HashMap<String, String>();
            ...
            List<SolrIndexDocument> resultsCompleteMultiSelect = new LinkedList<SolrIndexDocument>();
            if(facetMultiSelectTrue)
            {
    ...
    public static String autoSuggestionList(HttpServletRequest request, HttpServletResponse response) 
    {
        ...
        List<String> autoSuggestionList = new LinkedList<String>();
        List<Long> autoSuggestionFreqList = new LinkedList<Long>();
    ...
    public static List<String> getAvailableFacilities(HttpServletRequest request)
    {
        ...
        List<String> availableFacilities = new LinkedList<String>();
    ...
    public static String searchShoppingList(HttpServletRequest request, HttpServletResponse response) 
    {
        try 
        {
            ...
            List<String> processedSearchItems = new LinkedList<String>();
            ...
            List resultShoppingListSearchPage = new LinkedList<>();
    ...
    public static Collection<GenericRefinement> buildAllFacetList(Delegator delegator, String productCategoryId, List<GenericRefinement> facetCatList, List<GenericRefinement> facetListPriceRange, List<GenericRefinement> facetListCustomerRating, List<GenericRefinement> facetList)
    {
        ...
        if (UtilValidate.isNotEmpty(productCategoryId))
        {
            ...
            try 
            {
                ...
                productFeatureCatGrpApplList = EntityQuery.use(delegator).from("ProductFeatureCatGrpAppl").where("productCategoryId", productCategoryId).queryList();
