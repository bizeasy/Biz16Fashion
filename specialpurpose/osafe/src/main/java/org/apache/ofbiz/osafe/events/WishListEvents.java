                        ...
                        if (UtilValidate.isNotEmpty(inventoryLevelMap))
                        {
             			    ...
             			    if ((inventoryLevel.doubleValue() < inventoryOutOfStockTo.doubleValue()) || (inventoryLevel.doubleValue() == inventoryOutOfStockTo.doubleValue()))
            			    {
             			    ...
             			    else
             			    {
        	                	...
        	                	org.apache.ofbiz.osafe.events.ShoppingCartEvents.setProductFeaturesOnCart(shoppingCart,productId);
                        ...
                        if (UtilValidate.isNotEmpty(inventoryLevelMap))
                        {
             			    ...
             			    if ((inventoryLevel.doubleValue() < inventoryOutOfStockTo.doubleValue()) || (inventoryLevel.doubleValue() == inventoryOutOfStockTo.doubleValue()))
            			    {
             			    ...
             			    else
             			    {
        	                	...
        	                	org.apache.ofbiz.osafe.events.ShoppingCartEvents.setProductFeaturesOnCart(shoppingCart,shoppingListItem.getString("productId"));
