package org.apache.ofbiz.osafe.services.paynetz;
...
//        validateParam(parameters, "udf3", address, false);
    ...
    public static class PayNetzTokenWrapper implements Serializable 
    {
        ...
        private static Map<String, PayNetzTokenWrapper> tokenPayNetzWrapperMap = new HashMap<String, PayNetzTokenWrapper>();
