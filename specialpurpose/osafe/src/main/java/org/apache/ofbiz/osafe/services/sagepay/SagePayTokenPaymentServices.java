...
package org.apache.ofbiz.osafe.services.sagepay;
            ...
            if (opp != null) 
            {
                if ("CREDIT_CARD".equals(opp.getString("paymentMethodTypeId"))) 
                {
                    ...
                    if (UtilValidate.isNotEmpty(billingAddress))
                    {
                        ...
                        GenericValue GeoCountry = (GenericValue) billingAddress.getRelatedOne("CountryGeo", true);
                    ...
                    if (UtilValidate.isNotEmpty(deliveryAddress)) 
                    {
                        ...
                        GenericValue GeoDeliverCountry = (GenericValue) deliveryAddress.getRelatedOne("CountryGeo", true);
...
//        Debug.logInfo("SagePay Token - buildOrderBasket context : " + context, module);
        ...
        Map<String, String> basketInfo = new HashMap<String, String>();
...
//        Debug.logInfo("SagePay Token ccCapture context : " + context, module);
    ...
    private static Map<String, Object> processCardCapturePayment(DispatchContext ctx, Map<String, Object> context) {
        ...
        try {
        	...
        	GenericValue billingAddress = (GenericValue) sagePayTokenPaymentMethod.getRelatedOne("PostalAddress", true);
