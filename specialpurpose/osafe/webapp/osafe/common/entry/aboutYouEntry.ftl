    	...
    	getAddressFormat("USER");
	  	...
	  	if (jQuery('#js_${fieldPurpose?if_exists}_ADDRESS_ENTRY').length)
	  	{
	  		...
	  		else
	  		{
	  			...
	  			<#assign defaultCountry = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"COUNTRY_DEFAULT")!"USA"/> 
...
<#assign COUNTRY_DEFAULT = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"COUNTRY_DEFAULT")!""/>
