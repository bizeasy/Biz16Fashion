<script type="text/javascript">
    ...
    function submitSearchForm(form) 
    {
        ...
        <#assign SEARCH_DEFAULT_TEXT = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"SEARCH_DEFAULT_TEXT")!""/>
    ...
    function displayActionDialogBoxQuicklook(dialogPurpose,elm) 
    {
       ...
       jQuery.get(url, function(data)
       {
           ...
           <#if QUICKLOOK_DELAY_MS?has_content && Static["org.apache.ofbiz.osafe.util.Util"].isNumber(QUICKLOOK_DELAY_MS) && QUICKLOOK_DELAY_MS != "0">
    ...
    jQuery(document).ready(function () 
    {
       <#if errorMessageList?has_content>
          <#list errorMessageList as errorMsg>           
            try
            { 				
              <#if errorMsg.getClass().getName() == "org.apache.ofbiz.base.util.MessageString">
        ...
        <#assign lightDelayMs = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"LIGHTBOX_DELAY_MS")!0/>  
...
<#-- end Light Box Cart -->
    ...
    function validateQtyMinMax(productId,productName,quantity) <#-- throws alert -->
    {
    	...
    	if(quantity != 0) 
        {
        	if(quantity < lowerLimit)
          	{
          	  	<#assign pdpMinQtyError = Static["org.apache.ofbiz.base.util.StringUtil"].replaceString(uiLabelMap.PDPMinQtyError, '\"', '\\"')/>
          	  	<#assign pdpMinQtyError = Static["org.apache.ofbiz.base.util.StringUtil"].wrapString(pdpMinQtyError)/>
          	...
          	{
              	<#assign pdpMaxQtyError = Static["org.apache.ofbiz.base.util.StringUtil"].replaceString(uiLabelMap.PDPMaxQtyError, '\"', '\\"')/>
              	<#assign pdpMaxQtyError = Static["org.apache.ofbiz.base.util.StringUtil"].wrapString(pdpMaxQtyError)/>
    ...
    <#assign PDP_QTY_MIN = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"PDP_QTY_MIN")!"1"/>
    <#assign PDP_QTY_MAX = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"PDP_QTY_MAX")!"99"/>
    ...
    function isQtyWhole(quantity,productName) <#-- throws alert -->
    {
    	if(!isWhole(quantity))
  		{
  			<#assign pdpQtyDecimalNumberError = Static["org.apache.ofbiz.base.util.StringUtil"].replaceString(uiLabelMap.PDPQtyDecimalNumberError, '\"', '\\"')/>
    ...
    function validateCart()
    {
        ...
        <#if shoppingCart?has_content>
            ...
            <#list shoppingCartItems as shoppingCartItem>
                ...
                <#assign productName = Static["org.apache.ofbiz.product.product.ProductContentWrapper"].getProductContentAsText(shoppingCartItem.getProduct(), "PRODUCT_NAME", locale, dispatcher, "url")!"" >
                <#assign productQty = 0>
                ...
                <#assign PDP_QTY_MIN = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"PDP_QTY_MIN")!"1"/>
                <#if !PDP_QTY_MIN?has_content || !(Static["org.apache.ofbiz.osafe.util.Util"].isNumber(PDP_QTY_MIN))>
                  <#assign PDP_QTY_MIN = "1"/>
                </#if>
                <#assign PDP_QTY_MAX = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"PDP_QTY_MAX")!/>
                ...
                <#if productAttributes?has_content>
                  ...
                  <#assign productAttrPdpQtyMin = Static["org.apache.ofbiz.entity.util.EntityUtil"].getFirst(productAttrPdpQtyMin!)?if_exists /> 
                  <#assign productAttrPdpQtyMax = Static["org.apache.ofbiz.entity.util.EntityUtil"].getFirst(productAttrPdpQtyMax!)?if_exists /> 
