	<div class="${request.getAttribute("attributeClass")!}">
		<#if orderItemShipGroups?exists && orderItemShipGroups?has_content>
		   ...
		   <#assign checkoutGiftMessage = Static["org.apache.ofbiz.osafe.util.Util"].isProductStoreParmTrue(request,"CHECKOUT_GIFT_MESSAGE") />
						      ...
						      <#if product?has_content>
						          ...
						          <#if productAttributes?has_content>
						              ...
						              <#if pdpGiftMessageAttributes?has_content>
						                  <#assign pdpGiftMessageAttribute = Static["org.apache.ofbiz.entity.util.EntityUtil"].getFirst(pdpGiftMessageAttributes)/>
