	...
	<ul class="displayDetail order">
	    ...
	    <li>
	    	...
	    	<div>
	     		...
	     		<span>
                    <#if orderHeader?has_content>
                        <#assign FORMAT_DATE = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"FORMAT_DATE")!""/>
                        ${(Static["org.apache.ofbiz.osafe.util.Util"].convertDateTimeFormat(orderHeader.orderDate, FORMAT_DATE))!"N/A"}
                    </#if>
	     		</span>
	    	</div>
	    </li>
