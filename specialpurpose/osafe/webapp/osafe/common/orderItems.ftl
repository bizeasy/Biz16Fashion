        ...
        <table id="order_display" class="standardTable" summary="CurrentOrder_TABLE_SUMMARY">
            ...
            <#list orderItems as orderItem>
                  ...
                  <#if shipGroup?has_content>
                      ...
                      <#if orderHeader?has_content && (orderHeader.statusId == "ORDER_COMPLETED" || orderItem.statusId == "ITEM_COMPLETED") >
                          ...
                          <#if shipDate?has_content>
                              ...
                              <#assign shipDate = Static["org.apache.ofbiz.base.util.UtilDateTime"].toDateString(shipDate,preferredDateFormat)!""/>
                          </#if>
                      </#if>
              ...
              <#if !productCategoryId?has_content>
                  <#assign currentProductCategories = Static["org.apache.ofbiz.product.product.ProductWorker"].getCurrentProductCategories(product)![]>
              ...
              <#if product.isVariant?if_exists?upper_case == "Y">
                 ...
                 <#if !productCategoryId?has_content>
                      <#assign currentProductCategories = Static["org.apache.ofbiz.product.product.ProductWorker"].getCurrentProductCategories(virtualProduct)![]>
                      <#if currentProductCategories?has_content>
                          <#assign productCategoryId = currentProductCategories[0].productCategoryId!"">
                      </#if>
                  </#if>
             ...
             <#assign productFriendlyUrl = Static["org.apache.ofbiz.osafe.control.SeoUrlHelper"].makeSeoFriendlyUrl(request,'eCommerceProductDetail?productId=${urlProductId}&productCategoryId=${productCategoryId!""}')/>
             <#assign IMG_SIZE_CART_H = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"IMG_SIZE_CART_H")!""/>
             <#assign IMG_SIZE_CART_W = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"IMG_SIZE_CART_W")!""/>
