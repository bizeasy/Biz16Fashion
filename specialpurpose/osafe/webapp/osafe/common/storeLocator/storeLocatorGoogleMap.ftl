...
<script type="text/javascript">
    function loadScript() {
            ...
            script.type = "text/javascript";
            script.src = "${StringUtil.wrapString(geoChart.GeoMapRequestUrl)}&callback=hideDirection";
        ...
        function loadMap() {
          ...
          <#if geoChart.points?has_content>
            <#list geoChart.points as point>
              ...
              <#if point.userLocation?has_content && point.userLocation == "Y">
                marker_${point_index}.setIcon(new google.maps.MarkerImage("http://maps.google.com/mapfiles/kml/pal5/icon6.png"));
              </#if>
              <#if point.closures?has_content>
                ...
                <#if point.closures.storeDetail?has_content>
                  ...
                  <#if storeDetail.openingHoursContentId?exists && storeDetail.openingHoursContentId?has_content>
                    <#assign openingHours = Static["org.apache.ofbiz.content.content.ContentWorker"].renderContentAsText(dispatcher, delegator, storeDetail.openingHoursContentId, Static["javolution.util.FastMap"].newInstance(), locale, "", true)/>
                    <#if openingHours?has_content && openingHours != "null">
                      <#assign openingHours = Static["org.apache.ofbiz.osafe.util.Util"].getFormattedText(openingHours)/>
                  ...
                  <#if storeDetail.storeNoticeContentId?exists && storeDetail.storeNoticeContentId?has_content>
                    <#assign storeNotice = Static["org.apache.ofbiz.content.content.ContentWorker"].renderContentAsText(dispatcher, delegator, storeDetail.storeNoticeContentId, Static["javolution.util.FastMap"].newInstance(), locale, "", true)/>
                    <#if storeNotice?has_content && storeNotice != "null">
                      <#assign storeNotice = Static["org.apache.ofbiz.osafe.util.Util"].getFormattedText(storeNotice)/>
