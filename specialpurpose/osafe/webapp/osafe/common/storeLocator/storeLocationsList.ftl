	  ...
	  <#list storeDetailList as storeRow>
	    <#assign storeContentSpot = ""/>
	  	<#if storeRow.storeContentSpotContentId?has_content>
	        <#assign storeContentSpot = Static["org.apache.ofbiz.content.content.ContentWorker"].renderContentAsText(dispatcher, delegator, storeRow.storeContentSpotContentId, Static["javolution.util.FastMap"].newInstance(), locale, "", true)/>
	    </#if>
	   ...
	   <#if (storeRowIndex < gmapNumDisplay)>
	    ...
	    <#if storeContentSpot?exists && storeContentSpot?has_content && storeContentSpot != "null">
	           <div class="hiddenStoreContentSpotValue" style="display: none;"  >
	             ${Static["org.apache.ofbiz.osafe.util.Util"].getFormattedText(storeContentSpot)}
	           </div>
	    </#if>
				    ...
				    <#if openingHours?has_content && openingHours != "null">
					    <div class="entryRow">
					      <div class="entry">
					         ...
					         <div class="entryValue">
					            <span><p>${Static["org.apache.ofbiz.osafe.util.Util"].getFormattedText(openingHours)}</p></span>
					         </div>
					      </div>
					    </div>
				    </#if>
				    ...
				    <#if storeNotice?has_content && storeNotice != "null">
					    <div class="entryRow">
					      <div class="entry">
					         ...
					         <div class="entryValue">
					            <span><p>${Static["org.apache.ofbiz.osafe.util.Util"].getFormattedText(storeNotice)}</p></span>
					         </div>
					      </div>
					    </div>
				    </#if>
