<li class="${request.getAttribute("attributeClass")!}">
   <div class="eCommerceThumbNailHolder">
      ...
      <#assign IMG_SIZE_PLP_CAT_H = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"IMG_SIZE_PLP_CAT_H")!""/>
      <#assign IMG_SIZE_PLP_CAT_W = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"IMG_SIZE_PLP_CAT_W")!""/>
