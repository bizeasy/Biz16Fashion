<div>
  ...
  <#assign IMG_SIZE_PDP_POPUP_H = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"IMG_SIZE_PDP_POPUP_H")!""/>
  <#assign IMG_SIZE_PDP_POPUP_W = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"IMG_SIZE_PDP_POPUP_W")!""/>
