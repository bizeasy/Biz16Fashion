<#if plpProduct.isVirtual?if_exists?upper_case == "Y">
  <li class="${request.getAttribute("attributeClass")!}">
   <div class="plpSelectableFeature">
	<#assign inStock = true />
	<#assign isSellable = Static["org.apache.ofbiz.product.product.ProductWorker"].isSellable(plpProduct?if_exists) />
	<#if !isSellable>
	 <#assign inStock=false/>
	    ...
	    <#if !plpProduct.virtualVariantMethodEnum?exists || plpProduct.virtualVariantMethodEnum == "VV_VARIANTTREE">
	      <#assign plpSwatchImageHeight = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"IMG_SIZE_PLP_SWATCH_H")!""/>
	      <#assign plpSwatchImageWidth = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"IMG_SIZE_PLP_SWATCH_W")!""/>
