 ...
 <div class="js_eCommerceThumbNailHolder eCommerceThumbNailHolder">
    <div id="js_plpThumbImageContainer_${uiSequenceScreenHolder}_${plpProduct.productId}">
        <div class="js_swatchProduct">
	        ...
	        <a class="pdpUrl js_pdpUrl toolTipLink" title="${plpProductName!""}" href="${plpProductFriendlyUrl!"#"}" id="${plpProductId!}" <#if Static["org.apache.ofbiz.osafe.util.Util"].isProductStoreParmTrue(request,"PLP_FLYOUT_ACTIVE")>onMouseover="showPLPFlyout(this);" onMouseout="hideTooltip()"</#if>>
	            ...
	            <#if Static["org.apache.ofbiz.osafe.util.Util"].isProductStoreParmTrue(request,"PLP_FLYOUT_ACTIVE")>
	...
	<#if Static["org.apache.ofbiz.osafe.util.Util"].isProductStoreParmTrue(request,"QUICKLOOK_ACTIVE") && uiSequenceScreenHolder?has_content && uiSequenceScreenHolder == 'PLP'>
