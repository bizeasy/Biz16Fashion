<li class="${request.getAttribute("attributeClass")!}">
  <div>
    <#if pdpManufacturerProfileImageUrl?has_content>
      <#assign IMG_SIZE_PDP_MFG_H = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"IMG_SIZE_PDP_MFG_H")!""/>
      <#assign IMG_SIZE_PDP_MFG_W = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"IMG_SIZE_PDP_MFG_W")!""/>
