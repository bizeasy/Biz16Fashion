	  ...
	  <#list productVariantMapKeys as key>
	    ...
	    <#if variantContentIdMap?has_content && variantProdCtntWrapper?has_content >
	        ...
	        <#if variantContentId?has_content>
	           <#assign productLargeImageUrl = variantProdCtntWrapper.get("LARGE_IMAGE_URL", "url")!""/>
	        </#if>
	    	<#assign variantContentId = variantContentIdMap.get("DETAIL_IMAGE_URL")!""/>
	        <#if variantContentId?has_content>
	           <#assign productDetailImageUrl = variantProdCtntWrapper.get("DETAIL_IMAGE_URL", "url")!""/>
	        </#if>
	    	<#assign variantContentId = variantContentIdMap.get("THUMBNAIL_IMAGE_URL")!""/>
	        <#if variantContentId?has_content>
	           <#assign productThumbImageUrl = variantProdCtntWrapper.get("THUMBNAIL_IMAGE_URL", "url")!""/>
	        </#if>
	    </#if>
