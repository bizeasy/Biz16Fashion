<#if pdpVideoUrl?has_content && pdpVideoUrl!=''>
  <li class="${request.getAttribute("attributeClass")!}">
    <div class="pdpVideo">
      <#assign IMG_SIZE_PDP_VIDEO_H = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"IMG_SIZE_PDP_VIDEO_H")!""/>
      <#assign IMG_SIZE_PDP_VIDEO_W = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"IMG_SIZE_PDP_VIDEO_W")!""/>
