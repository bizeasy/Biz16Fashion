<#if pdpVideo360Url?has_content && pdpVideo360Url!=''>
 <li class="${request.getAttribute("attributeClass")!}">
  ...
  <#assign IMG_SIZE_PDP_VIDEO_360_H = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"IMG_SIZE_PDP_VIDEO_360_H")!""/>
  <#assign IMG_SIZE_PDP_VIDEO_360_W = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"IMG_SIZE_PDP_VIDEO_360_W")!""/>
