			...
			<div class="entryForm">
				...
				<#if textLinesNum?has_content && Static["org.apache.ofbiz.osafe.util.Util"].isNumber(textLinesNum) && (textLinesNum?number &gt; 0)>
					...
					<div id="textLinesEntry">
						<#assign textLinesNumMap = Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("textLinesNum", textLinesNum)>
		    			<#assign personalizedTextInstructions = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeUiLabels","PersonalizedTextInstructions",textLinesNumMap, locale ) />
						...
						<#list 0 .. (textLinesNum?number-1) as idx>
							...
							<div class="entry textLinePersonalized textLinePersonalized_${idx!}">
								<#assign lineNumMap = Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("idx", idx + 1)>
		    					<#assign lineNumberText = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeUiLabels","LineNumberCaption",lineNumMap, locale ) />
