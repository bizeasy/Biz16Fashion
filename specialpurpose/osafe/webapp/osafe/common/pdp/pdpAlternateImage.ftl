...
<li class="${request.getAttribute("attributeClass")!}">
  <div class="pdpAlternateImage">
    <div id="js_eCommerceProductAddImage">
      <#assign IMG_SIZE_PDP_THUMB_H = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"IMG_SIZE_PDP_THUMB_H")!""/>
      <#assign IMG_SIZE_PDP_THUMB_W = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"IMG_SIZE_PDP_THUMB_W")!""/>
