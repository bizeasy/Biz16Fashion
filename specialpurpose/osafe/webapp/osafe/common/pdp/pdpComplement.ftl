<li class="${request.getAttribute("attributeClass")!}">
  <#if complementProducts?has_content>
    <div class="js_pdpComplement">
       <#assign plpFacetGroupVariantSwatch = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"PLP_FACET_GROUP_VARIANT_SWATCH_IMG")!""/>
       <#assign plpFacetGroupVariantSticky =  Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"PLP_FACET_GROUP_VARIANT_PDP_MATCH")!""/>
       <#assign facetGroupMatch = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"FACET_GROUP_VARIANT_MATCH")!""/>
       ...
       <div class="boxList productList">
            <#list complementProducts as complementProduct>
                ...
                <#if isPlpPdpInStoreOnly?exists>
                    <script language="JavaScript" type="text/javascript">eval(checkProductInStorePlp('${isPlpPdpInStoreOnly}', '${uiSequenceScreen}_${complementProduct.productIdTo}'));</script>
                </#if>
