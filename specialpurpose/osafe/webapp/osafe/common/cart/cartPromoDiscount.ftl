  ...
  <#list appliedPromoList as appliedPromo >   
    <li class="${request.getAttribute("attributeClass")!}">
      <div>
         ...
         <span><@ofbizCurrency amount=Static["org.apache.ofbiz.order.order.OrderReadHelper"].calcOrderAdjustment(appliedPromo.cartAdjustment, shoppingCartSubTotal) isoCode=currencyUom  rounding=globalContext.currencyRounding/></span>
      </div>
    </li>
  </#list>
</#if>