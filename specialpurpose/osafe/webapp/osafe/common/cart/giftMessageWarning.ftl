<#if totalQuantityWithGiftMess?exists && totalQuantityWithGiftMess?has_content && totalQuantityAllowGiftMess?exists && totalQuantityAllowGiftMess?has_content>
  ...
  <#if totalQuantityAllowGiftMess &gt; totalQuantityWithGiftMess>
    <#assign giftMessageWarningMap = Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("totalItems", totalQuantityAllowGiftMess, "itemsWithoutGiftMessage", totalQuantityWithoutGiftMess)>
    <#assign giftMessageWarningText = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeUiLabels","GiftMessageWarning",giftMessageWarningMap, locale) />
