<div class ="${request.getAttribute("attributeClass")!} orderConfirmEmailAlert">
  ...
  <#assign CHECKOUT_EMAIL_ALERT = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"CHECKOUT_EMAIL_ALERT")!""/>
  <#if CHECKOUT_EMAIL_ALERT?has_content && Static["org.apache.ofbiz.base.util.UtilValidate"].isInteger(CHECKOUT_EMAIL_ALERT)>
