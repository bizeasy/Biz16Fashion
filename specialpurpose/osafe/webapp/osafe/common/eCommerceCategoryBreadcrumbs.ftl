...
<#assign FACET_VALUE_STYLE = Static["org.apache.ofbiz.osafe.util.Util"].getProductStoreParm(request,"FACET_VALUE_STYLE")!"DEFAULT"/>
...
<div class="breadcrumbs">
  <ul id="breadcrumb">
    ...
    <#if searchText?has_content && filterGroupValues?has_content>
      <li>
        <#assign searchText = Static["org.apache.ofbiz.base.util.StringUtil"].wrapString(searchText)!/>
