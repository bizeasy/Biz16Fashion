<#if storeHoursContentId?has_content>
  <#assign storeHoursTextData = Static["org.apache.ofbiz.content.content.ContentWorker"].renderContentAsText(dispatcher, delegator, storeHoursContentId, Static["javolution.util.FastMap"].newInstance(), locale, "", true)/>
...
<#if storeNoticeContentId?has_content>
  <#assign storeNoticeTextData = Static["org.apache.ofbiz.content.content.ContentWorker"].renderContentAsText(dispatcher, delegator, storeNoticeContentId, Static["javolution.util.FastMap"].newInstance(), locale, "", true)/>
...
<#if storeContentSpotContentId?has_content>
  <#assign storeContentSpotData = Static["org.apache.ofbiz.content.content.ContentWorker"].renderContentAsText(dispatcher, delegator, storeContentSpotContentId, Static["javolution.util.FastMap"].newInstance(), locale, "", true)/>
  ...
  <div class="displayBox">
	...
	<div class="entryRow">
	  <div class="entry">
	    ...
	    <div class="entryValue">
	      <span>${Static["org.apache.ofbiz.osafe.util.Util"].getFormattedText(storeHoursTextData)}</span>
	    </div>
	  </div>
	</div>
	<div class="entryRow">
	  <div class="entry">
	    ...
	    <div class="entryValue">
	      <span>${Static["org.apache.ofbiz.osafe.util.Util"].getFormattedText(storeNoticeTextData)}</span>
	    </div>
	  </div>
	</div>
	<div class="entryRow">
	        ...
	        <#if storePhone?has_content>
	          <#if storePhone.contactNumber?has_content>
	            <#if storePhone.contactNumber?length &gt; 6>
	              ...
	              <#assign fullPhone= Static["org.apache.ofbiz.osafe.util.Util"].formatTelephone(areaCode, contactPhoneNumber?if_exists, FORMAT_TELEPHONE_NO!)/>
	              ${fullPhone!""}
	            <#else>
...
${Static["org.apache.ofbiz.osafe.util.Util"].getFormattedText(storeContentSpotData)}
