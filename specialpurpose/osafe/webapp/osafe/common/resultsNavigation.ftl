...
<#if productCategoryId?exists && productCategoryId?has_content>
    ...
    <#assign sortUrl = Static["org.apache.ofbiz.osafe.control.SeoUrlHelper"].makeSeoFriendlyUrl(request,'eCommerceProductList${sortUrl}')/>
</#if>  
    ...
    <div class="pagingLinks">
			<#if productCategoryId?exists && productCategoryId?has_content>
			  ...
			  <#else>
			    ...
			    <#assign nextPrevUrl = Static["org.apache.ofbiz.osafe.control.SeoUrlHelper"].makeSeoFriendlyUrl(request,'eCommerceProductList${nextPrevUrl}')/>
			  </#if>
