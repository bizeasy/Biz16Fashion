...
<div class="shippingAddress">
    ...
    <#if !addressBookInstructions?has_content>
        <#assign addressBookInstructions = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeUiLabels", "ShippingAddressInstructionsInfo", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("shoppingCartSize",shoppingCartSize), locale)>
    </#if>
