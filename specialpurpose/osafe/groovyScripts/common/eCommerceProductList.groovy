...
String searchText = org.apache.ofbiz.osafe.util.Util.stripHTML(parameters.searchText);
String searchTextSpellCheck = org.apache.ofbiz.osafe.util.Util.stripHTML(parameters.searchTextSpellCheck);
